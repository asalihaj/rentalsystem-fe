        ...
        <Grid sx={{display:'flex',textAlign:'center'}}>
            ...
            <Paper elevation={20} style={paperStyle}>
                ...
                <form style={{marginTop:20,padding:2}}>
                    ...
                    <TextField style={{marginTop:5}}id="standard-basic" variant="standard"fullWidth label='Email' placeholder="Enter your Email"/>
                    <TextField style={{marginTop:5}}id="standard-basic" variant="standard"fullWidth label='Phone Number' placeholder="Enter your Phone Number"/>
                    <TextField style={{marginTop:5}}id="standard-basic" variant="standard"fullWidth label='Password' placeholder="Enter your Password"/>
                    <TextField style={{marginTop:5}}id="standard-basic" variant="standard"fullWidth label='Confirm Password' placeholder="Confirm your Password"/>
